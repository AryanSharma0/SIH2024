...
const TempDriver = () => {
  ...
  useEffect(() => {
    const unsubscribe = onValue(vehicalRef, (snapshot) => {
      ...
      setVehicalData(
        // {
        //   lat: 18.84728193133834,
        //   long: 83.02086466232038,
        // }
        data
  ...
  // const navigateToSomePoint = () => {
  //   if (chooseOption === "navigate") {
  //     setChooseOption(null);
  //     setDestination(null);
  //   } else {
  //     setChooseOption("navigate");
  //   }
  // };
                ...
                return (
                  <Polygon
                    ...
                    options={{
                      ...
                      fillOpacity: vehicalData._id === index ? 0.6 : 0.4,
